#!/usr/bin/env bash
	...
	export _PACKAGES_SCRIPT="/root/custom/packages/all/12_1_daemon_install.sh"
	...
	# this is temporarily until the script finished
	chroot /mnt /bin/bash -c 'su - -c \"${_PACKAGES_SCRIPT}\"'
